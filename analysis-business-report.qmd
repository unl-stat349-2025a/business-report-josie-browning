...
Steps: 
- Using CDC or BoS, find the difference between falls of office workers and non-office workers. See if I can identify where the numbers in the claims come from.
- identify solid reason why that number is stupid as fuck to use (raw statistic)
- break down of injuries for office workers
- look into details of office worker falls, severity/cause
  - maybe compare to severity of non-office worker injuries
...
office_codes <- c("^51", "^52", "^53", "^54", "^561")
